...
class VaccinationMatrixPage extends StatelessWidget {

  const VaccinationMatrixPage({ Key? key }) : super(key: key);
   ...
   Widget build(BuildContext context) {
      ...
      appBar: AppBar(
        ...
        title: const Text('Vacinação Matrizes'),
        centerTitle: true,
      ),
            ...
            children: [
              ...
              FutureBuilder(
                  future: context
                      ...
                      .getVaccinesByPigStage(PigStage.MATRIX.value),
