...
class VaccinationBreederPage extends StatelessWidget {

  const VaccinationBreederPage({ Key? key }) : super(key: key);
   ...
   Widget build(BuildContext context) {
      ...
      appBar: AppBar(
        ...
        title: const Text('Vacinação Reprodutores'),
        centerTitle: true,
      ),
            ...
            children: [
              ...
              FutureBuilder(
                  future: context
                      ...
                      .getVaccinesByPigStage(PigStage.BREEDER.value),
